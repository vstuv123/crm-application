...
const GetUnArchivedCustomers = () => {
  const searchRef = useRef("");
  const [search, setSearch] = useState("");
  const [sort, setSort] = useState("");
  const [company, setCompany] = useState("");
  const [industry, setIndustry] = useState("");
  const { data, isLoading } = useGetNonArchivedCustomersQuery({ search, sort, company, industry });
    ...
    <>
        {
            (isLoading || !data) ? (
              ...
              <Box className="container">
                <MetaData title={"CRM - UnArchived Customers Manager"} />
...
export default GetUnArchivedCustomers

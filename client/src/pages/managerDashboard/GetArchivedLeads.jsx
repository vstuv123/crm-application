...
import { useGetArchivedLeadsQuery } from "../../store/slices/leadSlice";
...
const GetArchivedLeads = () => {
  ...
  const { data, isLoading } = useGetArchivedLeadsQuery({ search, sort, source });
    ...
    <>
        {
            (isLoading || !data) ? (
              ...
              <Box className="container">
                <MetaData title={"CRM - Archived Leads Manager"} />
                <Box sx={{ mt: 1, mb: 1 }}>
...
export default GetArchivedLeads

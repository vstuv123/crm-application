...
import { useGetNonArchivedLeadsQuery } from "../../store/slices/leadSlice";
import { useGetAllSalesManagerQuery } from "../../store/slices/saleSlice";
...
const SaleReportsManager = () => {
  ...
  useGetNonArchivedLeadsQuery({ search, sort, source });
const { data: salesData, isLoading: saleLoading } =
  useGetAllSalesManagerQuery({ sort, value, closedDate });
...
export default SaleReportsManager;

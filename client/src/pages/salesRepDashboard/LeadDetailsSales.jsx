...
import { useGetLeadDetailsSalesQuery } from '../../store/slices/leadSlice';

const LeadDetailsSales = () => {
    const { id } = useParams();
    const navigate = useNavigate();
    const {data, isLoading} = useGetLeadDetailsSalesQuery(id);
  ...
  return (
    <Box sx={{ height: "100%", width: "100%", display: "flex", justifyContent: "center", alignItems: "center", gap: "100px" }} >
      <MetaData title={"CRM - Lead Details SalesRep"} />
...
export default LeadDetailsSales
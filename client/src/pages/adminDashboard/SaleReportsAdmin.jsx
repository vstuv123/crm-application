...
import { useGetNonArchivedLeadsAdminQuery } from "../../store/slices/leadSlice";
...
const SaleReportsAdmin = () => {
  ...
  useGetNonArchivedLeadsAdminQuery({ search, sort, source });
...
export default SaleReportsAdmin;
